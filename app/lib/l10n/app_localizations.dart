...
abstract class AppLocalizations {
  ...
  /// No description provided for @scamAlerts.
  ///
  /// In en, this message translates to:
  /// **'Scam Alerts'**
  String get scamAlerts;

  /// No description provided for @paymentAnalysis.
  ///
  /// In en, this message translates to:
  /// **'Payment Analysis'**
  String get paymentAnalysis;

  /// No description provided for @aiVerdictBreakdown.
  ///
  /// In en, this message translates to:
  /// **'AI VERDICT BREAKDOWN'**
  String get aiVerdictBreakdown;
  ...
  /// No description provided for @blockPayee.
  ///
  /// In en, this message translates to:
  /// **'Block Payee'**
  String get blockPayee;

  /// No description provided for @payeeBlockedSuccess.
  ///
  /// In en, this message translates to:
  /// **'Payee blocked successfully.'**
  String get payeeBlockedSuccess;

  /// No description provided for @addedToTrustlist.
  ///
  /// In en, this message translates to:
  /// **'Added {payee} to Trustlist'**
  String addedToTrustlist(String payee);

  /// No description provided for @proceedAnyway.
  ///
  /// In en, this message translates to:
  /// **'Proceed Anyway (I trust this)'**
